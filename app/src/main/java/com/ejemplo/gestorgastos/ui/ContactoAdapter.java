...
public class ContactoAdapter extends RecyclerView.Adapter<ContactoAdapter.ContactoViewHolder> {
    ...
    public ContactoAdapter(List<Contacto> contactoList, Context context) {
        ...
        this.prefs = context.getSharedPreferences("ConfigNegocio", Context.MODE_PRIVATE);
    }
    ...
    public void onBindViewHolder(@NonNull ContactoViewHolder holder, int position) {
        ...
        holder.btnWhatsapp.setOnClickListener(v -> {
            ...
            // Usar el prefijo guardado en ajustes (por defecto 549)
            String prefijo = prefs.getString("prefijo_wsp", "549");
            
            if (soloNumeros.length() == 10) {
                soloNumeros = prefijo + soloNumeros;
            }
